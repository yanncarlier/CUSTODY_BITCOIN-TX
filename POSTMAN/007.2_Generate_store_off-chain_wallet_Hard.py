...
conn = http.client.HTTPSConnection("btcpay.bitcoin-tx.com")
payload = "{\n  \"enabled\": true,\n  \"derivationScheme\": \"zpub6rGxU2Jf7ZiKL6e1ZYsQyHho7XCz2tr3Q532VZCbMnjwJy1qT6j2VKN1FAJhKCdJJWAoV5keLBaEtiaKbdqnkeGZn2cV4CVD4EPZ59nzSQL\",\n  \"label\": \"string\",\n  \"accountKeyPath\": \"abcd82a1/84'/0'/0'\"\n}"
headers = {
...
conn.request("PUT", "/api/v1/stores/irXaHsUunrnECscXxn8Qm8cYB7ou83sQcYtUPy3kpjR/payment-methods/onchain/BTC", payload, headers)
